<div class="container-fluid bg-white mt-5">
  ...
  <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Satya Vaishnavi Chakka</h6>
  ...
  {
      let bs_class = (type == 'success') ? 'alert-sucess' : 'alert-danger';
  ...
  login_form.addEventListener('submit', (e)=>{
    ...
    xhr.onload = function(){      
      if(this.responseText == 'inv_email_mob'){
        ...
        alert('error',"Acoount Suspended! Please contact Admin.");
      }
  ...
  function checkLoginToBook(status,room_id){
    if(status){
      ...
      alert('error','Please loginto book room!');
    }
  }
